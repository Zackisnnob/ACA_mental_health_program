...
# with col1:
    with st.form('Form1'):
        ...
        if submitted:
            ...
            st.write(f':blue[You are the #{df.shape[0]} user. Thanks for using.]') 
            st.write(f"The probability that one should be treated of mental health: :red[{round(Ypredict[0][1]*100, 1)}%].")
